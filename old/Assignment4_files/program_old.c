...
int main()
{
	...
	printf("\n************** Cpu state initially **************");
	display();
	assignment4();  //Stores predifined values in memory to demonstrate Assignment 4.
	printf("\n************** Storing predifined values in memory to demonstrate Assignment 4 **************");
	display();
	asm_read();
